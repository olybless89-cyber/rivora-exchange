...
async function initiatePayment(
  ...
  if (!r.ok) {
    ...
    throw new Error(err.error || "Could not generate payment link");
  }
  return r.json();
}
      ...
      <AppLayout>
        <div style={{ padding: "60px 24px", textAlign: "center" }}>
          ...
          <p style={{ color: "#9C9C9C", fontSize: 14, marginBottom: 24 }}>
            We could not confirm your transfer yet. If you have already paid, contact support with your reference.
          </p>
          {txRef && (
        ...
        <div style={{ padding: "24px 20px" }}>
          ...
          <Card style={{ padding: 20, marginBottom: 16, border: "1px solid rgba(212,175,55,0.2)" }}>
            ...
            <p style={{ fontSize: 13, color: "#9C9C9C", margin: "0 0 14px", lineHeight: 1.6 }}>
              Tap the button below to open your secure payment page and follow the bank transfer instructions.
            </p>
          ...
          <Card style={{ padding: 20, marginBottom: 24, border: "1px solid rgba(255,255,255,0.06)" }}>
            ...
            <p style={{ fontSize: 13, color: "#9C9C9C", margin: "0 0 14px", lineHeight: 1.6 }}>
              Once your transfer is complete, tap below and your balance will be credited instantly.
            </p>
            <Button
